...
# Configuración visual global con fuentes más grandes
...
# Orden estricto para las barras y las leyendas
MODEL_ORDER = [
...
def process_times():
    ...
    for file_path in files:
        ...
        # Aplicamos el nombre correcto; si no está en el dic, usa el del archivo
    ...
    # Filtramos y ordenamos correctamente usando 'Sort_Key'
    ...
    if not df_shots.empty:
        ...
        sns.lineplot(
            ...
            dashes=line_styles,
            markers=True,
            linewidth=3.5,            # Líneas más gruesas para el PDF
            markersize=12,            # Puntos más grandes
            errorbar=None, 
        ...
        # Textos más grandes
        # plt.title("Evolución de Tiempos de Inferencia: Shots", fontsize=22, fontweight='bold', pad=20)
